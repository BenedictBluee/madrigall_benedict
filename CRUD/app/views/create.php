...
<body class="bg-gray-900 text-green-400 font-mono min-h-screen flex items-center justify-center">
  <div class="w-full max-w-md bg-gray-800 rounded-2xl shadow-lg border border-green-500 p-8">
    <h1 class="text-3xl font-bold text-center mb-6 tracking-widest">🎮 CREATE USER</h1>
    ...
    <form action="<?=site_url('users/create');?>" method="post" class="space-y-4">
      ...
      <div class="flex justify-between items-center pt-4">
        <button type="submit" 
                class="px-6 py-2 bg-green-600 hover:bg-green-500 rounded-lg 
                       shadow-md shadow-green-500/50 transition">
          🚀 Submit
        </button>
