...
<style>
  ...
  * {
  ...
  body {
    margin: 0;
    height: 100vh;
    background: radial-gradient(circle at top left, #4b2e25 0%, #1a120f 70%) fixed;
    display: flex;
    align-items: center;
  ...
  /* Subtle metal pattern using gradients */
  body::before {
    content: "";
    position: absolute;
    inset: 0;
